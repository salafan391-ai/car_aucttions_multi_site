...
class Tenant(TenantMixin):
    ...
    import_calc_shipping = models.PositiveIntegerField(default=7800, verbose_name="تكلفة الشحن - حجم متوسط (ر.س)")
    import_calc_shipping_small = models.PositiveIntegerField(default=6500, verbose_name="تكلفة الشحن - حجم صغير (ر.س)")
    import_calc_shipping_large = models.PositiveIntegerField(default=9200, verbose_name="تكلفة الشحن - حجم كبير (ر.س)")
    ...
    # Google Search Console: the meta-tag verification token (set by the gsc_register command)
    gsc_verification_token = models.CharField(max_length=255, blank=True, null=True, verbose_name="Google site verification token")

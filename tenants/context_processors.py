...
def tenant_branding(request):
    ...
    result = {
        ...
        "site_whatsapp_group": getattr(tenant, 'whatsapp_group', '') or "",
        "site_telegram_group": getattr(tenant, 'telegram_group', '') or "",
    ...
    "import_calc_show_shipping": bool(getattr(tenant, 'import_calc_show_shipping', True)),
    "import_calc_show_duty": bool(getattr(tenant, 'import_calc_show_duty', True)),
    "import_calc_show_vat": bool(getattr(tenant, 'import_calc_show_vat', True)),
    "import_calc_show_clearance": bool(getattr(tenant, 'import_calc_show_clearance', True)),
    "import_calc_show_inspection": bool(getattr(tenant, 'import_calc_show_inspection', True)),
    ...
    "import_calc_sa_fees": getattr(tenant, 'import_calc_sa_fees', None) or [],
    "import_calc_config": getattr(tenant, 'import_calc_config', None) or [],
    }

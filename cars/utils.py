...
colors_dict = {
    'Pearl Two-Tone':'لؤلؤي ثنائي اللون',
    'Brown Two-Tone':'بني ثنائي اللون',
    'Turquoise':'فيروزي',
    'Silver Two-Tone':'فضي ثنائي اللون',
    'Gold Two-Tone':'ذهبي ثنائي اللون',
    'Orange':'برتقالي',
    'Purple':'بنفسجي',
    'Green':'أخضر',
    'Burgundy':'بورغندي',
    'Gold':'ذهبي',
    'White Two-Tone':'أبيض ثنائي اللون',
    'Yellow':'أصفر',
    'Bright Silver':'فضي فاتح',
    'Silver Metallic':'فضي معدني',
    'Light Gold':'ذهبي فاتح',
    ...
    'Black Two-Tone':'أسود ثنائي اللون',
    'Pink':'وردي',
    'White':'أبيض',
    'Gray':'رمادي',
    'Black':'أسود',
    ...
    "Teal": 'أزرق مخضر',
    # ── Added: colours found in use but previously untranslated ──
    "Unknown": 'غير محدد',
    "Etc": 'غير محدد',
    "Others": 'غير محدد',
    "Dark Green": 'أخضر داكن',
    "Light Silver": 'فضي فاتح',
    "Creamy": 'كريمي',
    "Cream": 'كريمي',
    "Creamy White": 'أبيض كريمي',
    "Creamy Beige": 'بيج كريمي',
    "Ivory": 'عاجي',
    "Atlas White": 'أبيض أطلس',
    "Metallic": 'معدني',
    "Metal": 'معدني',
    "Black Two Tone": 'أسود ثنائي اللون',
    "Platinum": 'بلاتيني',
    ...
    "Tomboy Khaki": 'كاكي',
    "Kaki": 'كاكي',
    "Black Pearl": 'أسود لؤلؤي',
    "Tazman Blue": 'أزرق تازمان',
    "Oxford Blue": 'أزرق أكسفورد',
    "Vanilla": 'فانيلا',
    "Serenity White Pearl (Optional)": 'أبيض لؤلؤي',
    "Gravity Gray": 'رمادي',
    "Mercury Blue": 'أزرق زئبقي',
    "Bronze": 'برونزي',
    "Maui Black": 'أسود',
    "Cardiff Green": 'أخضر',
    "Ebony Black": 'أسود أبنوسي',
    "Violet": 'بنفسجي',
    "Velvet": 'مخملي',
    "Midnight Silver Metallic": 'فضي معدني داكن',
    "Cosmic Blue": 'أزرق كوني',
    "Snow": 'أبيض ثلجي',
    "Sand Dunes": 'بيج رملي',
    "Red Pearl": 'أحمر لؤلؤي',
    "Fiery Red": 'أحمر ناري',
    "Copper": 'نحاسي',
    "Ceramic Blue": 'أزرق سيراميك',
    "오션 블루": 'أزرق محيطي',
    "밀라노 레드": 'أحمر ميلانو',
    "맑은 은색": 'فضي',
    "마티라블루(ev전용)": 'أزرق ماتيرا',
}
...
fuel_types_dict = {
    ...
    'Gasoline': 'بنزين',
    'CNG': 'غاز طبيعي مضغوط',
    'Gasoline + CNG': 'بنزين + غاز',
    'Gasoline + LPG': 'بنزين + غاز',    
    'Hydrogen': 'هيدروجين',
    'LPG': 'غاز',
...
car_models_dict = {
  ...
  "casper": "كاسبر",
    ...
    'Rapide': 'رابيد',
    'Qashqai': 'قشقاي',
    'C4 SpaceTourer': 'C4 سبيس تورر',
    'C4 Picasso': 'C4 بيكاسو',
    'Mustang': 'موستانج',
    'Spark': 'سبارك',
    'Golf': 'جولف',
    'Artura': 'أرتورا',
    ...
    'F-Pace': 'إف-بيس',
    'GS': 'جي إس',
    'V12 Vanquish': 'فانتاج V12',
    'Trax': 'تراكس',
    'Altima': 'ألتيما',
    'Urus': 'أوروس',
    'Touareg': 'طوارق',
    'F12berlinetta': 'F12 برلينيتا',
    'Alto Lapin': 'ألتو لابين',
    'Clubman': 'كلوبمان',
    'Bentayga': 'بنتايجا',
    'Orlando': 'أورلاندو',
    'Jimny': 'جمني',
    ...
    'Royal':'رويال',
    '2er':'الفئة الثانية',
    "Series-1":"الفئة الأولى",
    "Series-2":"الفئة الثانية",
    "Series-3":"الفئة الثالثة",
    "Series-4":"الفئة الرابعة",
    "Series-5":"الفئة الخامسة",
    "Series-6":"الفئة السادسة",
    "Series-7":"الفئة السابعة",
    "Series-8":"الفئة الثامنة",
    "Series-9":"الفئة التاسعة",
